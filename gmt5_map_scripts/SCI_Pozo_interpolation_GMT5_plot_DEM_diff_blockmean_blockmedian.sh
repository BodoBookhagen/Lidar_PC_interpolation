...
convert -quality 100 -density 300 ${POSTSCRIPT3::-3}.png ${POSTSCRIPT4::-3}.png -splice 0x25 -background "#ffffff" -append figures/Pozo_catchment_zoom_D_blockmean_blockmedian.png
